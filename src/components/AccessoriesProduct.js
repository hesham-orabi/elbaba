...
import AccessoriesProducts from '../api/AccessoriesProducts.json';

class AccessoriesProduct extends React.Component {
                            ...
                            <div className='col-md-6 col-xs-12 text-left info'>
                                ...
                                <div className='row ' id='cart'>
                                    ...
                                    <div className='col-md-12'>
                                        <button className='btn-cart' onClick={(e) => this.AddToCart(e) }><i class="fal fa-shopping-cart"></i> Add To Cart</button>
                                    </div>
                                </div>
                            </div>
...
export default connect(null,mapDispatchToProps) (AccessoriesProduct);
